 ...
 * Licensed under MIT (https://github.com/tabalinas/jsgrid/blob/master/LICENSE)
	* Modifications by Daniel Patterson. 2019:
	* 	- [Enter] keypress on open editor saves changes and closes edit.
	*		-	[Esc] keypress on open editor cancels changes and closes edit.
	*		-	Select-based grid cells are now sorted by textField instead of
	*				valueField.
	*		-	Support for external filters added.
	*  - Eliminated screen scroll reset when rendering the grid. This allows external
	*    controls elsewhere on the page to retain their focused position through a
...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _renderGrid: function() {
									...
									console.log("Scroll setting: " + scroll);
        ...
        editTemplate: function(value) {
            if(!this.editing)
                return this.itemTemplate.apply(this, arguments);
												...
												//	DEP
												// console.log("Wiring keypress for text editor.");
												$result.on("keypress", function(e)
												{
													if(e.which == 13)
													{
...
(function(jsGrid, $, undefined) {
    ...
    function SelectField(config) {
        ...
        // this.sorter = this.valueType;
								//	When binding to relative data, the value field may be the
								//	access key to the base record but the text field is the
								//	value that will be displayed on the screen and sorted for
								//	the user.
								//	In this version, we are going to use the text as lookup.
								//	Because the value field holds the key for finding the
								//	text field, the parameters will still contain those key
								//	values. The key values are used to lookup
								this.sorter = function(value1, value2)
								{
									// console.log("Select lookup: " + value1 + " to " + value2);
									var cCount = this.items.length;
									var cIndex = 0;
									var cItem = null;
									var result = 0;
									var text1 = "";
									...
									{
										cItem = this.items[cIndex];
										if(cItem[this.valueField] == value1)
										{
											text1 = cItem[this.textField];
										}
										if(cItem[this.valueField] == value2)
										{
											text2 = cItem[this.textField];
										}
    ...
    SelectField.prototype = new NumberField({
        ...
        editValue: function() {
            ...
            return this.valueType === numberValueType ? parseInt(val || 0, 10) : val;
								...
								{
									//	In this version, we are going to use the values as lookup.
